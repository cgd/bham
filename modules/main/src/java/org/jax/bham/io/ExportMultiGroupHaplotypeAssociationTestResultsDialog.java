 ...
 */
public class ExportMultiGroupHaplotypeAssociationTestResultsDialog extends JDialog
{
    /**
     * our logger
     */
    private static final Logger LOG = Logger.getLogger(
            ExportMultiGroupHaplotypeAssociationTestResultsDialog.class.getName());
    
    /**
     * every {@link java.io.Serializable} is supposed to have one of these
     */
    private static final long serialVersionUID = -3610879586264840748L;
     ...
     */
    public ExportMultiGroupHaplotypeAssociationTestResultsDialog(
            Frame parent,
            BhamProject project)
    {
        super(parent, "Export Multi-Group Haplotype Association Test Results...", false);
    ...
    private void postGuiInit()
    {
        this.outputFileButton.addActionListener(new ActionListener()
        {
            ...
            {
                ExportMultiGroupHaplotypeAssociationTestResultsDialog.this.browseOutputFiles();
            }
        });
        ...
        this.okButton.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ExportMultiGroupHaplotypeAssociationTestResultsDialog.this.ok();
            }
        });
        ...
        this.cancelButton.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ExportMultiGroupHaplotypeAssociationTestResultsDialog.this.cancel();
            }
        });
        ...
        this.helpButton.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ExportMultiGroupHaplotypeAssociationTestResultsDialog.this.showHelp();
            }
        });
        
        for(MultiGroupHaplotypeAssociationTest test: this.project.getMultiGroupHaplotypeAssociationTests())
        {
        ...
        try
        {
            if(this.validateData())
            {
                ...
                FlatFileWriter flatFileWriter = new FlatFileWriter(
                        writer,
                        format);
                MultiGroupHaplotypeAssociationTest test = this.getSelectedTest();
                ExportMultiGroupHaplotypeAssociationTestResultsTask exportTask =
                    new ExportMultiGroupHaplotypeAssociationTestResultsTask(
                            test,
                            flatFileWriter,
                            true);
     ...
     *          the selected test
     */
    private MultiGroupHaplotypeAssociationTest getSelectedTest()
    {
        return (MultiGroupHaplotypeAssociationTest)this.testDataComboBox.getSelectedItem();
    }
