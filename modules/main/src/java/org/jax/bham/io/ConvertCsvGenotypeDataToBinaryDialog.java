...
/**
 * Dialog for converting a CSV genotype data source into a binary
 * genotype data source
 * @author <A HREF="mailto:keith.sheppard@jax.org">Keith Sheppard</A>
 */
public class ConvertCsvGenotypeDataToBinaryDialog extends javax.swing.JDialog
{
    /**
     * every {@link java.io.Serializable} is supposed to have one of these
     */
    private static final long serialVersionUID = -2470749645878549268L;
    
    private static final Logger LOG = Logger.getLogger(
            ConvertCsvGenotypeDataToBinaryDialog.class.getName());
     ...
     *          parent component
     */
    public ConvertCsvGenotypeDataToBinaryDialog(java.awt.Frame parent)
    {
        super(parent, "Convert CSV Genotype Data to Binary", false);
        this.initComponents();
        this.postGuiInit();
    }
    ...
    private void postGuiInit()
    {
        this.importFilesButton.addActionListener(new ActionListener()
        {
            ...
            {
                ConvertCsvGenotypeDataToBinaryDialog.this.browseImportFiles();
            }
        });
        ...
        this.exportDirButton.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ConvertCsvGenotypeDataToBinaryDialog.this.browseExportDirs();
            }
        });
        ...
        this.helpButton.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ConvertCsvGenotypeDataToBinaryDialog.this.showHelp();
            }
        });
        ...
        this.okButton.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ConvertCsvGenotypeDataToBinaryDialog.this.ok();
            }
        });
        ...
        this.cancelButton.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ConvertCsvGenotypeDataToBinaryDialog.this.cancel();
            }
        });
        ...
        this.importFilesTextField.getDocument().addDocumentListener(new SimplifiedDocumentListener()
        {
            ...
            protected void anyUpdate(DocumentEvent e)
            {
                ...
                ConvertCsvGenotypeDataToBinaryDialog.this.importFilesChanged();
            }
        });
        ...
        ItemListener chromoAndPositionItemListener = new ItemListener()
        {
            ...
            public void itemStateChanged(ItemEvent e)
            {
                ...
                {
                    ConvertCsvGenotypeDataToBinaryDialog.this.chromosomeOrPositionColumnChanged();
                }
            }
        };
        ...
        try
        {
            if(this.validateData())
            {
                ...
                GenotypeParser parser = new GenotypeParser(
                        ...
                        this.chromosomeColumnComboBox.getSelectedIndex(),
                        this.positionColumnComboBox.getSelectedIndex());
                ConvertCsvGenotypeDataToBinaryTask importDataTask = new ConvertCsvGenotypeDataToBinaryTask(
                        parser,
                        importFiles,
                        exportDir);
                MultiTaskProgressPanel progressTracker =
                    BhamApplication.getInstance().getBhamFrame().getMultiTaskProgress();
                progressTracker.addTaskToTrack(importDataTask, true);
